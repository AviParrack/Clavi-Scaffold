# Avi Parrack — Web Presence

*Canonical list of Avi's public links and profiles. Agents read this whenever they need to share, link, or reference Avi's online presence on his behalf — e.g. attaching the scheduling link to a meeting outreach, hyperlinking his name in an email, citing his Substack in a post, including his X handle in a Twitter thread.*

*Single source of truth: when a link changes, update here once and every skill / agent picks up the new value. Add new links anytime — agents will use them where relevant.*
...
| Surface | Link | When to use |
|---|---|---|
| Spotify | https://open.spotify.com/user/31fdggmfiswbfr2dduc4exfxcymy | Music taste / lifestyle context. Share when conversation turns to music, playlists, taste. |
| Goodreads | https://www.goodreads.com/user/show/190305823-avi-parrack | Reading list / book context. Share when discussing what Avi is reading or for book recommendations exchange. |
...
**Cold outreach to academics / researchers:** Lead with **Website** for general identity, **LinkedIn** if the recipient is more LinkedIn-native (industry, policy, etc.).

**Twitter/X content:** Link the **X** handle in bios or when cross-posting. Reference Substack/Website where on-topic.

## Adding new links

When Avi mentions a new public surface (a new platform, a new project page, a podcast feed, etc.):
1. Add it to this file in the appropriate section (Primary if frequently used, Secondary otherwise).
2. Note when it should be used (the "When to use" column).
3. If it changes default behavior in any skill (e.g., a new email signature link), update the relevant skill or playbook to point here.

Skills currently referencing this file:
